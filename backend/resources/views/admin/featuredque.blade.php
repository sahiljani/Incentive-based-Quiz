...
@section('content')
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Add Featured question</h4>
        </div>
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('featuredque.store') }}" method="POST" id="editform" >
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input name="question" id="name" type="text" class="form-control"
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Featured Question List</h6>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" style="table-layout: fixed;">
                            ...
                            <tbody>
                              @foreach ($featuredquestion as $key=>$item)
                              <tr>
                                <th>{{$key+1}}</th>
                                <td style="word-break:break-word">{{$item->question}}</td>
                                ...
                                <td>
                                    <div class="icons-list row">
                                        ...
                                        '{{$item->correct}}')"> <i
                                            ...
                                            onclick="DeleteData('{{route('featuredque.deleted',[$item->id])}}')"
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="editmodal">Edit Featured Question</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="btn-close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('featuredque.edited') }}" method="POST" id="editform" >
                    @csrf
...
@push('custom-scripts')
    ...
    <script>
        ...
        function EditData(id, question, option1, option2, option3, option4, correct){

            const ModalInput  = document.querySelector("#editmodal form");
            ModalInput.id.value = id;
            ModalInput.question.value = question;
