...
const Footer = () => {
  ...
  return (
    ...
    <div className="footer bg-[#0f172a] flex z-[99]
    md:px-2 py-2 items-center justify-center fixed 
    bottom-0 md:max-w-[500px] md:w-[500px] min-w-[360px] w-full  xs:w-full" > 

       
        
        <Link to="/category" className={(location.pathname === "/category")? 
        "bg-[#1a2f77] flex flex-col px-8 py-2 rounded-full w-[100px] md:w-[130px] items-center hover:bg-[#1a2f77]" : 
        "flex flex-col px-8 py-2 rounded-full items-center w-[100px] md:w-[130px] hover:bg-[#1a2f77]"  }>
        ...
        <Link to="/home" className={(location.pathname === "/home")? 
        "bg-[#1a2f77] flex flex-col px-8 py-2 rounded-full w-[100px] md:w-[130px] items-center hover:bg-[#1a2f77]" : 
        "flex flex-col px-8 py-2 rounded-full items-center w-[100px] md:w-[130px] hover:bg-[#1a2f77]"  }>
