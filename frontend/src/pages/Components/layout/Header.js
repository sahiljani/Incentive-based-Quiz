...
const Header = () => {    
    ...
    const mobileOpener = ()=>{
        const mobilemenu_container = document.querySelector('.menulist');
        mobilemenu_container.classList.toggle('translate3d_show')
    }
    ...
    :""    
        ...
        <div className='mobilemenu_container translate3d_hide md:hidden'>
            <div className='menulist min-h-screen w-full bg-[#111827] fixed top-0 left-0 opacity-[1] block'>
                <div className='menucontent'>

                    <div onClick={mobileOpener} className='backbtn flex items-center my-5 ml-5'>
                    ...
                    <div className="content_menu flex flex-wrap my-10 justify-start">
                        <div className='singlemenu flex flex-col w-[33%]'>
