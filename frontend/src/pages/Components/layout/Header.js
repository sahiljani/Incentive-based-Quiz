...
const Header = () => {    
    ...
    <div className='header px-2 w-full flex item-center justify-around py-2 items-center mb-10 md:w-[500px]'>
    {(settingData)?
    <Helmet>
            <meta charSet="utf-8" />
    ...
    :""    
        ...
        <div className='mobilemenu_container translate3d_hide opacity-0'>
            <div className='menulist min-h-screen w-full bg-[#111827] fixed top-0 left-0  block md:max-w-[500px] md:w-[500px] min-w-[360px] w-full '>
        ...
        <div className='mobilemenu_container translate3d_hide'>
